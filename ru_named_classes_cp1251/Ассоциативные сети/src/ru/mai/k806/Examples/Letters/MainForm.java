 ...
 * MainForm.java
 *
 * Created on 28 Январь 2007 г., 0:41
 */

package ru.mai.k806.Examples.Letters;

import ru.mai.k806.commons.Sample;
import ru.mai.k806.commons.ГетероассоциативнаяСеть;
...
// TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int index = (int)new ГетероассоциативнаяСеть(samples).whatIsIt(letterUserInput.getLinearizedContent());
        if(index<0)
